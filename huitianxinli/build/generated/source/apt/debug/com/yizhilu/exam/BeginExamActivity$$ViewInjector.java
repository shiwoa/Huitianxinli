...
public class BeginExamActivity$$ViewInjector<T extends com.yizhilu.exam.BeginExamActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131361883, "field 'gridViewOne'");
    target.gridViewOne = finder.castView(view, 2131361883, "field 'gridViewOne'");
    view = finder.findRequiredView(source, 2131361884, "field 'gridViewTwo'");
    target.gridViewTwo = finder.castView(view, 2131361884, "field 'gridViewTwo'");
    view = finder.findRequiredView(source, 2131361882, "field 'gridViewLayout'");
    target.gridViewLayout = finder.castView(view, 2131361882, "field 'gridViewLayout'");
    ...
    view = finder.findRequiredView(source, 2131362472, "field 'timeText'");
    target.timeText = finder.castView(view, 2131362472, "field 'timeText'");
    view = finder.findRequiredView(source, 2131362106, "field 'timeLayout'");
    target.timeLayout = finder.castView(view, 2131362106, "field 'timeLayout'");
    view = finder.findRequiredView(source, 2131362315, "field 'nullText'");
    target.nullText = finder.castView(view, 2131362315, "field 'nullText'");
  ...
  @Override public void reset(T target) {
    ...
    target.gridViewOne = null;
    target.gridViewTwo = null;
    target.gridViewLayout = null;
