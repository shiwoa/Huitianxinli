...
public class AvailableVoucherFragment extends BaseFragment {
	...
	private static AvailableVoucherFragment availableVoucherFragment; // 本类的实体
	...
	public View getLayoutView(LayoutInflater inflater, ViewGroup container,
		...
		inflate = inflater.inflate(R.layout.fragment_available_voucher,
				container, false);
		return inflate;
	}
	...
	public void initView() {
		...
		voucherFragment = VoucherFragment.getInstance(); // 得到代金券的实体
	 ...
	 */
	public static AvailableVoucherFragment getInstentce() {
		if (availableVoucherFragment == null) {
			availableVoucherFragment = new AvailableVoucherFragment();
		}
		return availableVoucherFragment;
	}
