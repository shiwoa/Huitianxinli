...
/**
 * @author bin 修改人: 时间:2016-1-16 下午1:12:07 类说明:不可用代金券
 */
public class PastVoucherFragment extends BaseFragment {

	private View inflate; // 总布局
	private static PastVoucherFragment pastVoucherFragment; // 本类对象
	...
	public View getLayoutView(LayoutInflater inflater, ViewGroup container,
		...
		inflate = inflater.inflate(R.layout.fragment_past_voucher, container,
				false);
		return inflate;
	}
	...
	private void setVoucherData(final int page, PublicEntity publicEntity) {
		try {
			...
			if (publicEntity.isSuccess()) {
				...
				listView.setAdapter(new CouponAdapter(getActivity(),
						allCouponList));
			}
