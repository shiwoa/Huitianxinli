...
public class AvailableCouponFragment extends BaseFragment {
	private static AvailableCouponFragment availableCouponFragment;  //本类对象
	...
	public View getLayoutView(LayoutInflater inflater, ViewGroup container,
		...
		inflate = inflater.inflate(R.layout.fragment_available_coupon, container,false);
		return inflate;
	}
	 ...
	 * 方法说明:获取本类对象
	 */
	public static AvailableCouponFragment getInstentce(){
