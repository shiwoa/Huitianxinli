...
public class PastCouponFragment extends BaseFragment {
	...
	public View getLayoutView(LayoutInflater inflater, ViewGroup container,
		...
		inflate = inflater.inflate(R.layout.fragment_past_coupon, container,false);
		return inflate;
	}
	 ...
	 * @author bin
	 * 修改人:
	 * 时间:2016-1-14 下午3:15:53
	 * 方法说明:获取本类对象
	 */
	public static PastCouponFragment getInstentce(){
		if(pastCouponFragment == null){
			pastCouponFragment = new PastCouponFragment();
		}
