 ...
 * @author bin
 * 修改人:
 * 时间:2016-2-23 上午11:29:08
 * 类说明:不可用会员券
 */
public class PastMemberFragment extends BaseFragment {
	private static PastMemberFragment pastMemberFragment;  //本类对象
	...
	public View getLayoutView(LayoutInflater inflater, ViewGroup container,
		...
		inflate = inflater.inflate(R.layout.fragment_past_member, container,false);
		return inflate;
	}
	 ...
	 * 方法说明:联网获取不可用代金券的方法
	 */
	private void getPastMemberData(int userId, final int page) {
		RequestParams params = new RequestParams();
		params.put("userId", userId);
		params.put("page.currentPage", page);
		params.put("type", 3);  //3会员券
