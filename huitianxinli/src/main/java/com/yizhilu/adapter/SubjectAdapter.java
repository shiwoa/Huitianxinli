...
public class SubjectAdapter extends BaseAdapter {
	...
	public SubjectAdapter(Context context,List<EntityCourse> subjectList) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(position == 0){
			...
			holder.subjectText.setText(subjectList.get(position-1).getSubjectName());
		}
		if(index == position){
