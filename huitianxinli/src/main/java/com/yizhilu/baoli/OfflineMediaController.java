...
public class OfflineMediaController extends IjkBaseMediaController {
	...
	public OfflineMediaController(Context context, AttributeSet attrs) {
		super(context, attrs);
		mRoot = this;
		mFromXml = true;
	 ...
	 * @param isUseReffwd
	 */
	public OfflineMediaController(Context context, boolean isUsePreNext,String str) {
		super(context);
	...
	protected View makeControllerView() {
		mRoot = ((LayoutInflater) mContext
				...
				R.layout.offfline_ijkmedia_controller, this);
		return mRoot;
	}
	...
	protected void initControllerView(View v) {
		...
		selectSRT.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (sRTPopupView.isShowing()) {
					...
					sRTPopupView.show(mAnchor, ijkVideoView.getVideo(),
							ijkVideoView.getCurrSRTKey());
				}
			}
		});
		...
		title_tv = (TextView) mRoot.findViewById(R.id.title_tv);
	...
	public interface OnFinshLinstener {
		public void onFinsh();
	}

	private OnFinshLinstener mFinshListener;

	public void OnFinshLinstener(OnFinshLinstener l) {
		mFinshListener = l;
	}
	...
	// 隐藏横竖屏的方法
	public void hint() {
		btn_boardChange.setVisibility(View.GONE);
	}
