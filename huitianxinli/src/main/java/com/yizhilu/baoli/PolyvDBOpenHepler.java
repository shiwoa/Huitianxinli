...
//		db.execSQL("create table if not exists downloadlist (vid varchar(20),title varchar(100),duration varchar(20),filesize int,bitrate int,percent int default 0,total int default 0,primary key (vid, bitrate))");
		db.execSQL("create table if not exists downloadlist (vid varchar(20),title varchar(100),duration varchar(20),filesize int,bitrate int,image varchar(100),percent int default 0,total int default 0,primary key (vid, bitrate))");
	}
